...
created: function() { 
  let self = this;
  fetch('https://newsapi.org/v2/top-headlines?country=us&apiKey=8e2aabc469ba4ae284afde1ec29b20e4')
 ...
 data: function() {
  ...
  fetch('https://newsapi.org/v2/everything?q='+self.searchTerm + '&language=en&apiKey=8e2aabc469ba4ae284afde1ec29b20e4').then(function(response) {
  return response.json();
  })
  .then(function(data) {
